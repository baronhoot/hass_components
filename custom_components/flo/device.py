...
class FloDeviceDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    async def _async_update_data(self):
        ...
        try:
            ...
            LOGGER.info(f"JSON decode error during presence ping: {e}")
    ...
    async def async_set_mode_home(self):
        ...
        try:
            ...
            LOGGER.info(f"JSON decode error during setting mode to home: {e}")
    ...
    async def async_set_mode_away(self):
        ...
        try:
            ...
            LOGGER.info(f"JSON decode error during setting mode to away: {e}")
    ...
    async def async_set_mode_sleep(self, sleep_minutes, revert_to_mode):
        ...
        try:
            ...
            LOGGER.info(f"JSON decode error during setting mode to sleep: {e}")
    ...
    async def async_run_health_test(self):
        ...
        try:
            ...
            LOGGER.info(f"JSON decode error during device health test: {e}")
    ...
    async def _update_device(self, *_) -> None:
        ...
        try:
            ...
            LOGGER.info(f"JSON decode error during device update: {e}")

    async def _update_consumption_data(self):
        ...
        try:
            ...
            # Attempt to fetch the water consumption data
            ...
            LOGGER.info(f"JSON decoding error encountered: {json_error}")
